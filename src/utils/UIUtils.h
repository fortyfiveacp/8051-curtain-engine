...
public:
    ...
    static Entity& createBackground(World& world, float windowWidth, float windowHeight, const char* texturePath);
    static Entity& createFadeInBackgroundLayer(World& world, float width, float height, const char* texturePath, float fadeDuration, float fadeDelay);
